...
v1.1.0 and v1.1.1. **The latest tag is `v1.1.1`; `main` carries the finished
v1.2.0 milestone, not yet tagged** — so a source build reports `1.2.0-src`
...
milestones** (`gh issue list --milestone v1.3.0`); `docs/ROADMAP.md` →
