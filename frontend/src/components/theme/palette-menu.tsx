...
export function PaletteMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        {/* Palette glyph — names the picker literally (colour themes), and
            distinct from the language globe now sitting beside it (§9). */}
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 21a9 9 0 0 1 0-18 9 8 0 0 1 9 8 4.5 4 0 0 1-4.5 4h-2.5a2 2 0 0 0-1 3.75 1.3 1.3 0 0 1-1 2.25" />
